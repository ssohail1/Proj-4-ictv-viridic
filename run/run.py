...
os.sytem('makeblastdb -in finfasta3r.fasta -dbtype nucl -out results/customdb')
...
os.system('blastn -db results/inputdb -query finfasta3r.fasta -out results/blastoutB.csv -evalue 1 -num_threads 12 -word_size 7 -reward 2 -penalty -3 -gapopen 5 -gapextend 2 -outfmt "6 qseqid sseqid qstart qend nident qlen" ')
